...
export const ROLE_DETAILS: Record<Role, string> = {
  ...
  "killer-wife":
    "เริ่มต้นฝ่ายเมือง มี 2 หัวใจ เมื่อถูกโจมตีที่อนุมัติครั้งที่สอง คุณจะเปลี่ยนเป็น Killer ภาพนั้นนับเป็น 1 คิล และทีมใช้โควต้าร่วมกัน 3 คิลต่อชั่วโมง การตายจากระเบิดไม่ทำให้เปลี่ยนบทบาท",
  police:
    "ชี้ตัวผู้ต้องสงสัยที่ยังมีชีวิตได้ระหว่างเล่นหรือเมื่อถึงเวลานัดหมาย ชี้ถูก Killer คนใดก็ได้ฝ่ายเมืองชนะ ชี้ผิดฝ่าย Killer ชนะ หาก Killer โจมตีคุณและ Host อนุมัติ ฝ่ายเมืองชนะทันที",
  reporter:
    ...
    <Dialog title="วิธีเล่น KILLER" onClose={onClose}>
      ...
      <details className="rules-details">
        ...
        <div>
          ...
          <p>ตำรวจชี้ถูก ฝ่ายเมืองชนะ ชี้ผิด ฝ่าย Killer ชนะ หาก Host อนุมัติภาพโจมตีตำรวจ ฝ่ายเมืองชนะทันที หาก Killer ทุกคนตายจากระเบิด ฝ่ายเมืองชนะ แม้ตำรวจตายพร้อมกัน</p>
        </div>
      </details>
