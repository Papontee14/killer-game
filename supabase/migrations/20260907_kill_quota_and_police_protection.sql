...
begin
  ...
  if t.role_current='police' then update public.rooms set phase='ended',winner='city',quota_window_start=window_start where id=r.id; perform public.add_event(r.id,'winner','ฝ่ายเมืองชนะ'); return public.get_room_view(r.code); end if;
