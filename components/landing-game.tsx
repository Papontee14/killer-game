...
export function LandingGame() {
  ...
  function continueToRoom(event: React.FormEvent) {
    ...
    if (mode === "host") {
      ...
      rememberRoomCredentials(`host:${roomCode}`, { name: identity, pin: pin || "1234", playerPin: playerPin || "1234" });
