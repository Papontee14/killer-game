...
const cases = [
  ...
  [
    ...
    "คุณเปลี่ยนเป็น Killer แล้ว ขณะนี้คุณอยู่ Killer Side",
    "danger",
    "mask",
  ],
  [
  ...
  ["winner", "City Side ชนะ", "เกมจบแล้ว — City Side ชนะ", "success", "trophy"],
  ["winner", "City Side ชนะ เพราะ Host อนุมัติการโจมตี Police", "City Side ชนะ เพราะ Host อนุมัติการโจมตี Police", "success", "trophy"],
  [
    "winner",
    "Killer Side ชนะ",
